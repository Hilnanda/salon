                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="start_time" name="start_time"  value="{{ $coupon->start_date_time }}" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <!-- text input -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="end_time"  name="end_time"  value="{{ $coupon->end_date_time }}" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <!-- text input -->
